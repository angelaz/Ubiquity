...
#pragma mark    AudioSession Error Constants
	...
	/*!
	 ...
	 @constant		 kAudioSessionPermissionsError
	 The requested operation failed because the caller did not have permission to perform
	 the operation (e.g. attempting to set a record category without asking permission in a
	...
	enum
	{
		...
		kAudioSessionPermissionsError						= '!prm',
